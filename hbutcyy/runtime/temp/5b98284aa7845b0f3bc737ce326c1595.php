<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:65:"D:\www\hbutcyy\public/../application/index\view\mobile\login.html";i:1521200821;}*/ ?>
<html>
<head>
    <meta charset="UTF-8">
    <!--
    ...
    <title>登陆大学生创业园</title>
   <link href="/static/index/static/css/mobile/header.css" rel="stylesheet" type="text/css">
   <link href="/static/index/static/css/mobile/login.css" rel="stylesheet" type="text/css">
...
<div class="login">
	<form action="" method="post">
		<div class="account">
			<label>账号：</label>
			<input class="account-input" type="text" name="user_name" value="" placeholder="登陆账号">
		</div>

		<div class="pwd">
			<label>密码：</label>
			<input class="pwd-input" type="password" name="password" placeholder="密码">
		 </div>	
		 <div class="into">
