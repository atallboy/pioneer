<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"D:\www\hbutcyy\public/../application/admin\view\file\fileList.html";i:1520501623;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<?php foreach ($data as $v){
    echo '
            <tr class="text-c">
                ...
                <td style="display: none"></td>
                <td style="display: none"></td>
                <td><a href="../../admin/file/downFile?name='.$v['file'].'">下载</a></td>
                <td class="td-status"><span class="label label-success radius">'.$v['create_time'].'</span></td>
                <td class="td-manage"><a href="del?id='.$v['id'].'">删除</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="editFilePage?id='.$v['id'].'&oldname='.$v['file_name'].'&name='.$v['file'].'">修改文件</a></td>
            </tr>';}?>
