<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"D:\www\hbutcyy\public/../application/admin\view\active\editActive.html";i:1520238745;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<article class="page-container">
    <form action="../Active/updateActive" method="post" class="form form-horizontal" id="form-member-add">
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $data['publisher']; ?>" placeholder=""  name="publisher">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red"></span>发布时间：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $data['publish_time']; ?>" placeholder="" name="publish_time">
            </div>
        </div>		
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                <div class="radio-box">
                    <input name="status" type="radio" id="sex-1" value="未发布"
                    <?php if($data['status']=='未发布'){echo 'checked';}?>>
                    <label for="sex-1">未发布</label>
                </div>
                <div class="radio-box">
                    <input type="radio" id="sex-2" name="status" value="进行中"
                    <?php if($data['status']=='进行中'){echo 'checked';}?>>
                    <label for="sex-2">进行中</label>
                </div>
                <div class="radio-box">
                    <input type="radio" id="sex-3" name="status" value="已过期"
                    <?php if($data['status']=='已过期'){echo 'checked';}?>>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $data['object']; ?>" placeholder="" id="object" name="object">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red"></span>活动时间：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $data['time']; ?>" placeholder="" name="time">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $data['address']; ?>" placeholder="" name="address">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $data['detail']; ?>" placeholder="" name="detail">
            </div>
        </div>

        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">活动要求：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <script id="editor" type="text/plain" style="width:100%;height:400px;"></script>
            </div>
        </div>
        <div style="width: 400px;height: 100px;display: none" id="test">
            <textarea id="test3"><?php echo $data['regular']; ?></textarea>
        </div>
        <div class="row cl">
