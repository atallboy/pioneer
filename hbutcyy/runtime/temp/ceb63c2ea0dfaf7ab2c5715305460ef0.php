<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"D:\www\hbutcyy\public/../application/index\view\apply\addApply.html";i:1520994076;s:45:"../application/admin/view/public/header1.html";i:1515034424;s:44:"../application/admin/view/public/footer.html";i:1520218823;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
		  ...
		  function emptyValue(){
           ...
           function checkName(){
				...
				$.ajax({
					method:"get",
					dataType:"html",
					url:"http://hbutcyy.dxsbb.com/index.php/index/apply/checkTeamName?name="+name,
    ...
    <form action="dealFile" method="post" class="form form-horizontal" id="form-member-add" enctype="multipart/form-data" style="margin-left:-130px;">
       <input type="hidden" name="user_id" value="1">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="team_name" name="team_name" onmouseout="checkName()">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                ...
                <div class="radio-box">
                    <input type="radio"  name="register" value="2">
                    <label>否</label>
                </div>
            </div>
        </div>
