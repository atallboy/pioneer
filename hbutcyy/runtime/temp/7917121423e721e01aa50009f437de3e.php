<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"D:\www\hbutcyy\public/../application/admin\view\index\alterList.html";i:1514992883;s:66:"D:\www\hbutcyy\public/../application/admin\view\public\header.html";i:1520218805;s:66:"D:\www\hbutcyy\public/../application/admin\view\public\footer.html";i:1520218823;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<article class="page-container">
    <form action="alterList.html?behavior=modify&type=<?php echo($data['type']);?>&id=<?php echo $data['id']; ?>" method="post" class="form form-horizontal" id="form-member-add">
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                <div class="radio-box">
                    <input name="final" type="radio" id="sex-1" value="yes" <?php if($data['final']=='yes'){echo 'checked="checked"';}?>>
                    <label for="sex-1">是</label>
                </div>
                <div class="radio-box">
                    <input type="radio" id="sex-2" name="final" value="no" <?php if($data['final']=='no'){echo 'checked="checked"';}?>>
