<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"C:\websoft\www\pioneer\public/../application/admin\view\file\upload.html";i:1520178702;s:45:"../application/admin/view/public/header1.html";i:1515034424;s:44:"../application/admin/view/public/footer.html";i:1514290941;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
    ...
    <form action="dealFile" method="post" class="form form-horizontal" id="form-member-add" enctype="multipart/form-data">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="file_name" name="file_name">
            </div>
        </div>
