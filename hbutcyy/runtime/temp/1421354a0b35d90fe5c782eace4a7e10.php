<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"D:\www\hbutcyy\public/../application/index\view\staticpage\staticByOne.html";i:1520823402;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<?php foreach ($data as $v){
    echo '
            <tr class="text-c">
                ...
                <td class="td-manage"><a href="">删除已有静态页</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="byOne?id='.$v['id'].'">生成静态页</a></td>
            </tr>';}?>
