<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"D:\www\hbutcyy\public/../application/index\view\mobile\activeList.html";i:1521193823;}*/ ?>
<html>
<head>
    <meta charset="UTF-8">
    <!--
	...
	<div class="news-list">
		<ul>
			<?php foreach ($data as $k){
                echo '
			<li>
				<a href="./active?id='.$k['id'].'">
				<span class="l-title">'.$k['name'].'</span>
				<span class="l-time">'.$k['time'].'</span>					
				</a>
			</li>';}?>
